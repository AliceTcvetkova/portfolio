...
export const STRINGS = {
  en: {
    ...
    missingLocation: "Choose a place on the map",
    ...
    reportMapLabel: "Cleanup location",
    reportMapHint: "Tap the map to place or move the report pin.",
    useCurrentLocation: "Use my current location",
    chooseReportLocation: "Tap the map to choose a place",
    ...
    screenOnboardingSubtitle: "Turn polluted places into cleanup quests.",
    screenMapTitle: "Nearby cleanup tasks",
    screenMapSubtitle: "Tasks around you",
    screenReportTitle: "Report a polluted place",
    screenReportSubtitle: "Before photo + location",
    screenTaskTitle: "Cleanup task",
    screenTaskSubtitle: "Estimated reward",
    screenProofTitle: "Upload cleanup proof",
    screenProofSubtitle: "After photo from same spot",
    screenVerifyTitle: "Cleanup verified",
    screenVerifySubtitle: "Reward unlocked",
    screenProfileTitle: "Your impact",
    screenProfileSubtitle: "Cleanups, points, activity",
    screenSponsorTitle: "Fund local cleanups",
    screenSponsorSubtitle: "Sponsor visible impact",
    onboardingTitle: "Find polluted places. Clean them. Get rewarded.",
    onboardingBody: "A mobile map that turns real-world cleanup into verified local quests.",
    startExploring: "Start exploring",
    reward: "Reward",
    rewardPoints: "points",
    taskChecklist: "Checklist: bring gloves, collect visible plastic, upload after photo from same location.",
    acceptTask: "Accept task",
    continueProof: "Continue to proof",
    sponsorCampaign: "Sponsor campaign",
    fundedOf: "funded of",
  ...
  ru: {
    ...
    missingLocation: "Выберите место на карте",
    ...
    reportNew: "Сообщить",
    reportMapLabel: "Место уборки",
    reportMapHint: "Нажмите на карту, чтобы поставить или переместить пин репорта.",
    useCurrentLocation: "Использовать мою геолокацию",
    chooseReportLocation: "Нажмите на карту, чтобы выбрать место",
    ...
    screenOnboardingSubtitle: "Превращайте загрязнённые места в задания по уборке.",
    screenMapTitle: "Ближайшие задания",
    screenMapSubtitle: "Задачи рядом с вами",
    screenReportTitle: "Сообщить о загрязнении",
    screenReportSubtitle: "Фото «до» + геолокация",
    screenTaskTitle: "Задание на уборку",
    screenTaskSubtitle: "Предварительная награда",
    screenProofTitle: "Загрузить результат",
    screenProofSubtitle: "Фото «после» с того же места",
    screenVerifyTitle: "Уборка подтверждена",
    screenVerifySubtitle: "Награда разблокирована",
    screenProfileTitle: "Ваш вклад",
    screenProfileSubtitle: "Уборки, баллы, активность",
    screenSponsorTitle: "Поддержать уборки",
    screenSponsorSubtitle: "Спонсировать видимый результат",
    onboardingTitle: "Находите мусор. Убирайте. Получайте награды.",
    onboardingBody: "Мобильная карта превращает реальные уборки в проверяемые локальные задания.",
    startExploring: "Начать",
    reward: "Награда",
    rewardPoints: "баллов",
    taskChecklist: "Чеклист: возьмите перчатки, соберите видимый пластик, загрузите фото «после» с той же локации.",
    acceptTask: "Принять задание",
    continueProof: "Продолжить к фото",
    sponsorCampaign: "Спонсорская кампания",
    fundedOf: "собрано из",
    fundCampaign: "Поддержать"
  }
};
